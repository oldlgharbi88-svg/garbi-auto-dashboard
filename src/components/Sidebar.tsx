...
const navItems: NavItem[] = [
  ...
  { id: 'supplier-invoices', label: 'Supplier Invoices / فواتير الموردين', icon: 'receipt_long' },
  ...
  { id: 'companies', label: 'Societes', icon: 'business' },
  { id: 'checks', label: 'Checks', icon: 'payments' },
